...
public class PersonService {
    ...
    public PersonCreatedDTO addPerson(PersonDTO req) throws DoesNotExistException {
        ...
        final Coordinates coordinates = coordinatesRepository.getReferenceById(req.getCoordinatesId());
        final Location location = locationRepository.getReferenceById(req.getLocationId());

        java.time.ZoneId zid = java.time.ZoneId.of("Europe/Moscow");

        log.info("req.getCoordinatesId() = " + req.getCoordinatesId());
        log.info("req.getLocationId() = " + req.getLocationId());
